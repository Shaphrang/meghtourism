...
export default function FooterNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 flex justify-around py-2 shadow-md">
      <a href="/thrills" className="flex flex-col items-center justify-center text-xs text-gray-700 hover:text-blue-600 transition">
        <Map size={20} />
        <span className="text-[10px] mt-1">Adventures</span>
      </a>
      <a href="/homestays" className="flex flex-col items-center justify-center text-xs text-gray-700 hover:text-blue-600 transition">
        <BedDouble size={20} />
      ...
      <a href="/traveltips" className="flex flex-col items-center justify-center text-xs text-gray-700 hover:text-blue-600 transition">
        <Info size={20} />
